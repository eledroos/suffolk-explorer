/*
 * Vendored copy of fzstd 0.1.1 (ESM build), a pure-JavaScript Zstandard
 * decompressor. Source: https://cdn.jsdelivr.net/npm/fzstd@0.1.1/esm/index.mjs
 * Copyright (c) 2020 Arjun Barrett. MIT License.
 * https://github.com/101arrowz/fzstd
 *
 * Vendored because public/data/hayden.parquet uses ZSTD compression, which
 * hyparquet does not decode on its own, and the hyparquet `compressors` hook
 * must be synchronous in both browser and node. Do not edit by hand.
 */
// @ts-nocheck
